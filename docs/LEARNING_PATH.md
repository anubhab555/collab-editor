...
### 4. Learn the next collaboration upgrade
...
- Why is the current system not yet a CRDT?
- What problem does Yjs solve?
- What is the difference between delta sync and CRDT sync?
...
3. [Redis Scaling 101](./REDIS_SCALING_101.md)
4. [CRDT and Yjs 101](./CRDT_YJS_101.md)
